...
1. с использованием дебетовой карты
2. с использованием кредита по данным банковской карты
...
* IntelliJ IDEA - специальная среда разработки, необходимая для оптимизации работы
...
**Итого с учетом рисков: 124 часов**

## План сдачи работ
Автоматизация - 05.02.2022  
Подготовка отчетных документов - 10.02.2022  